...
global.ownername = "⌬ Clara-DV" //ur owner name
global.ytname = "YT: ⌬ Clara-DV" //ur yt chanel name
global.socialm = "Instagram: katyushaclara" //ur github or insta name
global.location = "Indonesia Bagian Tengah" //ur location

//bot bomdy 
global.owner = ['6281347927862']
global.ownertag = '6281347927862' //ur tag number
global.botname = '⌬ Felicia-MD' //ur bot name
...
global.mess = {
    ...
    botAdmin: '*〔❗〕Jadikan Bot Sebagai Admin Dulu*',
    owner: '*〔❗〕Fitur Khusus Owner Bot Ini*',
    group: '*〔❗〕Fitur Khusus Di Grup*',
    private: '*〔❗〕Fitur Khusus Di Chat Pribad*',
    bot: '*〔❗〕Fitur Ini Khusus Untuk Bot Felicia*',
    wait: '*〔❗〕Proses*',
    linkm: '*〔❗〕Sertakan Link Setelah Command*',
    error: '*〔❗〕Error*',
