...
XeonLft = await getBuffer(`https://hardianto.xyz/api/goodbye3?profile=${encodeURIComponent(ppuser)}&name=${encodeURIComponent(nama)}&bg=https://telegra.ph/file/d460e086f9f9bf6b04e17.jpg&namegb=${encodeURIComponent(metadata.subject)}&member=${encodeURIComponent(memb)}`)
                ...
                xeonbody = `𝗝𝗢𝗜𝗡 𝗧𝗛𝗘 𝗚𝗥𝗢𝗨𝗣\n
ʜɪ @${xeonName.split("@")[0]}
ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ${metadata.subject}
ᴍᴇᴍʙᴇʀ ᴛᴏ ${xmembers}
ᴊᴏɪɴ ᴛɪᴍᴇ ${xtime} ${xdate}\n\n`
      //if you copy the code value,
   //dont forget to put my name(Xeon) as credit
   //you fail to put, i sue you for sure!
let buttons = [
{buttonId: `wkwwk`, buttonText: {displayText: '𝗪 𝗘 𝗟 𝗖 𝗢 𝗠 𝗘'}, type: 1}
]
let buttonMessage = {
...
XeonBotInc.sendMessage(anu.id, buttonMessage, {quoted:unicorndoc})
                    ...
                    xeonbody = `𝗟𝗘𝗔𝗩𝗜𝗡𝗚 𝗧𝗛𝗘 𝗚𝗥𝗢𝗨𝗣\n
ɢᴏᴏᴅʙʏᴇ @${xeonName.split("@")[0]} 
ғʀᴏᴍ ɢʀᴏᴜᴘ ${metadata.subject}
ᴍᴇᴍʙᴇʀ ᴛᴏ ${xeonmembers}
ᴏᴜᴛ ᴛɪᴍᴇ ${xeontime} ${xeondate}\n\n`
      //if you copy the code value,
   //dont forget to put my name(Xeon) as credit
   //you fail to put, i sue you for sure!
let buttons = [
{buttonId: `wkwkwk`, buttonText: {displayText: '𝗚 𝗢 𝗢 𝗗 𝗕 𝗬 𝗘'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./XeonMedia/theme/cheems.xlsx'),
mimetype: docs,
