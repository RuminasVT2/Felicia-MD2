...
reply(`\`\`\`「 GROUP LINK DETECTED 」\`\`\`\n\n*You Wont Be Kicked By A Bot Because What You Send Is A Link To This Group.*`)
} else if (isUrl(m.text)) {
bvl = `\`\`\`「 GROUP LINK DETECTED 」\`\`\`\n\n*Admin Has Sent Another Group Link, Admin Is Free To Post Any Link.*`
...
bvl = `\`\`\`「 WA.ME LINK DETECTED 」\`\`\`\n\n*Admin Has Sent A Wa.me Link, Admin Is Free To Post Any Link.*`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
...
//antivirtex by xeon
  if (antiVirtex) {
  if (budy.length > 3500) {
  reply(`*Somebody Spammed Virus*\n*Bot Spam So That Viruses Sink*\n`.repeat(300))
  reply(`\`\`\`「 VIRUS DETECTED 」\`\`\`\n\n*This Is Not A Place For A Virtex Champion*`)
...
tos = ['*Perlindungan Hukum Terhadap Korban Toxic Relationship (Hubungan Beracun) di Kalangan Remaja yang dapat diberikan dengan Pasal 7 Undang-undang Nomor 13 Tahun 2006 mengenai Perlindungan Saksi dan Korban yang mana korban mempunyai hak atas kompensasi dalam kasus pelanggaran hak asasi manusia.*','*Maka dalam surah An-Nisa‟: 148 dari ayat tersebut, Allah membenci ucapan buruk, artinya adanya larangan dalam melakukan toxic, dan dalam surah Al-Mumtahanah dari ayat tersebut, melakukan toxic akan menimbulkan permusuhan, kebencian, sehingga dapat mengakibatkan putusnya ikatan silaturahmi.*','*Efesus 4 29 Janganlah ada perkataan kotor keluar dari mulutmu, tetapi pakailah perkataan yang baik untuk membangun, di mana perlu, supaya mereka yang mendengarnya, beroleh kasih karunia.*']
sin =  tos[Math.floor(Math.random() * (tos.length))]
reply(sin)
if (m.text) {
bvl = `\`\`\`「 BAD WORD DETECTED 」\`\`\`\n\n*You Are Using Bad Word But You Are An Admin Thats Why I Wont Kick You.*`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
...
if (!isBotAdmins) return
bvl = `\`\`\`「 YOUTTUBE VIDEO LINK DETECTED 」\`\`\`\n\n*Admin Has Sent A YouTube Video Link, Admin Is Free To Post Any Link.*`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
...
if (!isBotAdmins) return
bvl = `\`\`\`「 YOUTUBE CHANNEL LINK DETECTED 」\`\`\`\n\n*Admin Has Sent A YouTube Channel Link, Admin Is Free To Post Any Link.*`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
...
if (!isBotAdmins) return
bvl = `\`\`\`「 INSTAGRAM LINK DETECTED 」\`\`\`\n\n*Admin Has Sent A Instagram Link, Admin Is Free To Post Any Link.*`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
...
if (!isBotAdmins) return
bvl = `\`\`\`「 FACEBOOK LINK DETECTED 」\`\`\`\n\n*Admin Has Sent A Facebook Link, Admin Is Free To Post Any Link.*`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
...
if (AntiLinkTelegram)
if (!isBotAdmins) return
bvl = `\`\`\`「 TELEGRAM LINK DETECTED 」\`\`\`\n\n*Admin Has Sent A Telegram Link, Admin Is Free To Post Any Link.*`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
...
if (!isBotAdmins) return
bvl = `\`\`\`「 TIKTOK LINK DETECTED 」\`\`\`\n\n*Admin Has Sent A TikTok Link, Admin Is Free To Post Any Link.*`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
...
⏱️It's Been ${clockString(new Date - afkTime)}
`.trim())
        }
...
⏱️In ${clockString(new Date - user.afkTime)}
`.trim())
            user.afkTime = -1
            user.afkReason = ''
        }
...
if (q.includes('--help')) return reply(examkosong) 
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     let teksehmazeh = `*〔 USER INFO 〕*`
     teksehmazeh += `*❤️Blood* : ${getDarah(m.sender)}\n`
     teksehmazeh += `*⛓️Iron* : ${getBesi(m.sender)}\n`
...
XeonBotInc.sendText(m.chat, `*〔 GUESS THE SONG 〕*\n\nWhat Is The Name Of This Song?\n\n 🎤Artist : ${result.artist}\n⏱️Time : 60s`, msg).then(() => {
tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
})
await sleep(60000)
if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Answer: " + result.jawaban)
XeonBotInc.sendButtonText(m.chat, [{ buttonId: 'guess song', buttonText: { displayText: 'Guess the song' }, type: 1 }], `⏱️Time Has Run Out\nAnswer:  ${tebaklagu[m.sender.split('@')[0]]}\n\nWant to play? press the button below`, `${global.botname}`, m)
delete tebaklagu[m.sender.split('@')[0]]
}
...
let result = anu[Math.floor(Math.random() * anu.length)]
XeonBotInc.sendImage(m.chat, result.img, `*〔 GUESS THE PICTURE 〕*\n\n📑Please Answer The Question Above\n\n📖Description : ${result.deskripsi}\n⏱️Time : 60s`, m).then(() => {
tebakgambar[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
})
await sleep(60000)
if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Answer: " + result.jawaban)
XeonBotInc.sendButtonText(m.chat, [{ buttonId: 'guess picture', buttonText: { displayText: 'Guess the picture' }, type: 1 }], `⏱️Time Has Run Out\nAnswer:  ${tebakgambar[m.sender.split('@')[0]]}\n\nWant to play? press the button below`,`${global.botname}`, m)
delete tebakgambar[m.sender.split('@')[0]]
}
} else if (args[0] === 'word') {
...
let result = anu[Math.floor(Math.random() * anu.length)]
XeonBotInc.sendText(m.chat, `*〔 GUESS THE WORD 〕*\n\n📑Please Answer The Following Question\n\n${result.soal}\n⏱️Time : 60s`, m).then(() => {
tebakkata[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
})
await sleep(60000)
if (tebakkata.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Answer: " + result.jawaban)
XeonBotInc.sendButtonText(m.chat, [{ buttonId: 'guess word', buttonText: { displayText: 'Guess The Word' }, type: 1 }], `⏱️Time Out\nAnswer:  ${tebakkata[m.sender.split('@')[0]]}\n\nWant to play? press the button below`, `${global.botname}`, m)
delete tebakkata[m.sender.split('@')[0]]
}
...
let result = anu[Math.floor(Math.random() * anu.length)]
XeonBotInc.sendText(m.chat, `*〔 GUESS THE SENTENCE 〕*\n\n📑Please Answer The Following Question\n\n${result.soal}\n⏱️Time : 60s`, m).then(() => {
tebakkalimat[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
})
await sleep(60000)
if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Answer: " + result.jawaban)
XeonBotInc.sendButtonText(m.chat, [{ buttonId: 'guess sentence', buttonText: { displayText: 'Guess the Sentence' }, type: 1 }], `⏱️Time Out\nAnswer:  ${tebakkalimat[m.sender.split('@')[0]]}\n\nWant to play? press the button below`, `${global.botname}`, m)
delete tebakkalimat[m.sender.split('@')[0]]
}
...
let result = anu[Math.floor(Math.random() * anu.length)]
XeonBotInc.sendText(m.chat, `*〔 GUESS THE LYRICS 〕*\n\n🎼Fill The Missing Lyrics Below : *${result.soal}*?\n⏱️Time : 60s`, m).then(() => {
tebaklirik[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
})
await sleep(60000)
if (tebaklirik.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Answer: " + result.jawaban)
XeonBotInc.sendButtonText(m.chat, [{ buttonId: 'guess lyrics', buttonText: { displayText: 'Guess The Lyrics' }, type: 1 }], `⏱️Time Out\nAnswer:  ${tebaklirik[m.sender.split('@')[0]]}\n\nWant to play? press the button below`, `${global.botname}`, m)
delete tebaklirik[m.sender.split('@')[0]]
}
...
let result = anu[Math.floor(Math.random() * anu.length)]
XeonBotInc.sendText(m.chat, `*〔 GUESS THE SAYING 〕*\n\n📑Answer The Following Questions :*\n${result.soal}*\n⏱️Time : 60s`, m).then(() => {
...
console.log("Answer: " + result.jawaban)
XeonBotInc.sendButtonText(m.chat, [{ buttonId: 'guess saying', buttonText: { displayText: 'Guess The Saying' }, type: 1 }], `⏱️Time Out\nAnswer:  ${caklontong[m.sender.split('@')[0]]}\nDescription : ${caklontong_desk[m.sender.split('@')[0]]}\n\nWant to play? press the button below`, `${global.botname}`, m)
delete caklontong[m.sender.split('@')[0]]
delete caklontong_desk[m.sender.split('@')[0]]
}
}
...
if (isBanChat) return reply(mess.banChat)
                ...
                XeonBotInc.sendText(m.chat, `*〔 MATH 〕*\n\nWhat Is The Result Of\n*${result.soal.toLowerCase()}*\n\n⏱️Time: ${(result.waktu / 1000).toFixed(2)} Second`, m).then(() => {
...
if (isBanChat) return reply(mess.banChat)
             if (!text) return replay(`Use Someone's Name, Example : ${prefix + command} Bot`)
              ...
              reply(`👤Name : ${predea.data.name}\n*⚰️Dead At Age :* ${predea.data.age} Year.\n\n_Quick, Quick, Repent Bro, Because No One Knows About Death_`)
              break  
            case 'join': {
            	if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
if (isBanChat) return reply(mess.banChat)
                ...
                if (!isBotAdmins) return replay(`${mess.botAdmin}`)
                if (!isAdmins) return replay(`${mess.admin}`)
let teks = `*TAG ALL MEMBER GROUP*
 
*✉️Message : ${q ? q : 'no message'}*\n\n`
...
if (isBanChat) return reply(mess.banChat)
                ...
                let buttons = [
                        { buttonId: 'group open', buttonText: { displayText: '𝗢 𝗣 𝗘 𝗡' }, type: 1 },
                        { buttonId: 'group close', buttonText: { displayText: '𝗖 𝗟 𝗢 𝗦 𝗘' }, type: 1 }
                    ]
...
if (args.length < 1) return reply('type auto sticker ACTIVE To Enable\ntype auto sticker NON-ACTIVE To Disable')
if (args[0]  === 'on'){
...
replay('*Success In Turning off group chat antilink in this group*')
  ...
  let buttonsntilink = [
  { buttonId: `${command} on`, buttonText: { displayText: '𝗔𝗖𝗧𝗜𝗩𝗘' }, type: 1 },
  { buttonId: `${command} off`, buttonText: { displayText: '𝗡𝗢𝗡-𝗔𝗖𝗧𝗜𝗩𝗘' }, type: 1 }
  ]
  await XeonBotInc.sendButtonText(m.chat, buttonsntilink, `*👥 Please Click The Button Below*\n\nACTIVE To Enable\nNON-ACTIVE To Disable`, `${global.botname}`, m)
  }
  }
  break
...
if (isBanChat) return reply(mess.banChat)
                ...
                reply(`*${XeonBotInc.user.name} Has Been Unmuted In This Group*`)
                 ...
                 let buttons = [
                        { buttonId: 'mute on', buttonText: { displayText: '𝗔𝗖𝗧𝗜𝗩𝗘' }, type: 1 },
                        { buttonId: 'mute off', buttonText: { displayText: '𝗡𝗢𝗡-𝗔𝗖𝗧𝗜𝗩𝗘' }, type: 1 }
                    ]
...
let buttons = [
{buttonId: `gimage ${args.join(" ")}`, buttonText: {displayText: '𝗡 𝗘 𝗫 𝗧'}, type: 1}
]
let buttonMessage = {
image: { url: images },
...
if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                ...
                XeonBotInc.sendMessage(m.chat, { video: link, jpegThumbnail: await getBuffer(i.preview), caption: `*🗒️ Story ${i.type}*` }, { quoted: m }) 
                } else {
                    let link = await getBuffer(i.url)
                  XeonBotInc.sendMessage(m.chat, { image: link, jpegThumbnail: await getBuffer(i.preview), caption: `*🗒️ Story ${i.type}*` }, { quoted: m })                  
                }
            }
...
🗒️ Caption : ${lotwit.title ? lotwit.title : "undefined"}
🎬 Type : ${lotwit.medias[1].extension}
📹 Size : ${lotwit.medias[1].formattedSize}
🖇️ Link : ${lotwit.medias[1].url}

_Press The Button According To The Quality You Want _`
let buttons = [
...
if (isBanChat) return reply(mess.banChat)
            ...
            let bocil = require('@bochilteam/scraper')  
                bocil.facebookdlv2(`${text}`).then(async (data) => {                   
                    ...
                    txt += `💬 TITLE : ${data.title}\n`
                    txt += `🎞️ QUALITY : ${data.result[0].quality}\n`
...
🎞️ Size : ${resd.medias[0].formattedSize}

_For FHD Quality, Please Press the Button Below__`
let buttons = [
{buttonId: `fbddl ${resd.medias[1].url}`, buttonText: {displayText: '𝗙 𝗛 𝗗'}, type: 1}
]
let buttonMessage = {
...
if (isBanChat) return reply(mess.banChat)
	...
	if (isBanChat) return reply(mess.banChat)
            ...
            capt += ` 📚 Chapter: ${bab}\n`
            capt += ` 🖇️ Url: ${url}\n`
            capt += ` 🗒️ Description: ${description}`
...
if (isBanChat) return reply(mess.banChat)
	...
	if (isBanChat) return reply(mess.banChat)
            ...
            case 'animexxx':{
            	   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
                if (!text) return reply(`*Example : .animexxx Naruto`)
                await reply(mess.wait)
            ...
            case 'characterxxx': case 'karakterxxx':
               if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
                if (!text) return reply(`*Example .characterxxx Naruto*`)
                await reply(mess.wait)
            ...
            case 'manga2':
               if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
                if (!text) return reply(`*Example: .manga2 Naruto*`)
                await reply(mess.wait)
...
let srh = await manga.searchManga(q)
    ...
    mang += `🎞️ *Status: ${srh.data[0].status}*\n`;
...
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!q) return reply('*Example .tvschedule sctv*')
...
case 'tvsearch':
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!q) return reply('*Include TV Channel Name After Command*') 
...
for (let i of res) {
  no += 1
teks += `\n• ${no.toString()} •\n`
teks += `🎞️ Film: ${i.film_title}\n`
teks += `🖇️ Link: ${i.film_link}\n`
}
teks += `══════════════════`
replay(teks) 
})
...
break
	...
	if (isBanChat) return reply(mess.banChat)
            ...
            let capt = `Cinema Schedule From: ${text}\n\n`
            for (let i of res.result){
            capt += `💬 Title: ${i.title}\n`
            capt += `🖼️ Thumbnail: ${i.thumb}\n`
            capt += `🖇️Url : ${i.url}\n\n──────────────────────\n`
            }
...
if (isBanChat) return reply(mess.banChat)
                ...
                let random = anu[Math.floor(Math.random() * anu.length)]
                XeonBotInc.sendMessage(m.chat, { image: { url: random.male }, caption: `*For Boys*` }, { quoted: m })
                XeonBotInc.sendMessage(m.chat, { image: { url: random.female }, caption: `*For Girls*` }, { quoted: m })
            }
	    break
...
if (isBanChat) return reply(mess.banChat)
		let { quotesAnime } = require('./lib/scraperW')
                ...
                result = anu[Math.floor(Math.random() * anu.length)]
                let buttons = [
                    {buttonId: `quotesanime`, buttonText: {displayText: '𝗡 𝗘 𝗫 𝗧'}, type: 1}
                ]
                let buttonMessage = {
...
case 'wallpaper': case 'animewallpaper': case 'animewall': {
	if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
                if (!args.join(" ")) return reply("*Include Keyword After Command*")
		let { wallpaper } = require('./lib/scraperW')
                anu = await wallpaper(args)
                result = anu[Math.floor(Math.random() * anu.length)]
		let buttons = [
                    {buttonId: `.wallpaper ${args.join(" ")}`, buttonText: {displayText: '𝗡𝗘𝗫𝗧 𝗜𝗠𝗔𝗚𝗘'}, type: 1}
                ]
                let buttonMessage = {
...
case 'wiki': case 'wikipedia':
 	if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
if (args.length < 1) return reply('*Include Keyword After Command*')
const res2 = await XeonBotIncWiki(q).catch(e => {
return reply('*Not Found In Wikipedia Database*') 
}) 
...
break
            case 'wikimedia': {
            	 	if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                if (!text) return reply(`*Include Keywords After Command*`)
		let { wikimedia } = require('./lib/scraper')
                anu = await wikimedia(text)
                result = anu[Math.floor(Math.random() * anu.length)]
                let buttons = [
                    {buttonId: `wikimedia ${text}`, buttonText: {displayText: '𝗡𝗘𝗫𝗧 𝗜𝗠𝗔𝗚𝗘'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: result.image },
                    caption: `*WIKIMEDIA SEARCH*\n\n💬 Title : ${result.title}\n🌐 Source : ${result.source}\n🖇️ Media Url : ${result.image}`,
                    footer: XeonBotInc.user.name,
                    buttons: buttons,
                    headerType: 4
                }
...
texttk = `Want To Download Without Watermark Or Audio?\n
_Please Select The Button Below As Desired_`
let buttons = [
{buttonId: `ttnowm ${q}`, buttonText: {displayText: '©️ 𝗡𝗢 𝗪𝗔𝗧𝗘𝗥𝗠𝗔𝗥𝗞'}, type: 1},
{buttonId: `ttaud ${q}`, buttonText: {displayText: '🎵 𝗔𝗨𝗗𝗜𝗢'}, type: 1}
]
let buttonMessage = {
...
break
  case 'tiktoknowm': case 'ttnowm':{
  	if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
  if (!q) return reply('*Include Link After Command*')
  reply(mess.wait)
  if (!q.includes('tiktok')) return reply(`*That Not a TikTok Video Link*`)
   const musim_rambutan = await XeonBotIncTiktok(`${q}`).catch(e => {
 reply(mess.error) 
} )
   console.log(musim_rambutan)
   const xeonytiktoknowm = musim_rambutan.result.nowatermark
    XeonBotInc.sendMessage(from, { video: { url: xeonytiktoknowm }, caption: "*Done Converting To Video Without Watermark*" }, { quoted: m })
   }
  break
  case 'tiktokaudio':
case 'tiktokmusic':
...
let buttons = [
{buttonId: `ytvd ${ytvc.link}`, buttonText: {displayText: '🎥 𝗩𝗜𝗗𝗘𝗢'}, type: 1},
{buttonId: `ytad ${ytvc.mp3}`, buttonText: {displayText: '🎵 𝗠𝗨𝗦𝗜𝗖'}, type: 1}
]
let buttonMessage = {
...
break
case 'getmusic': case 'getvideo': case 'yt': case 'youtube': case 'ytmp3': case 'ytmp4': {
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
_Press The Button Below As Desired_`
let buttons = [
{buttonId: `ytvd ${res.link}`, buttonText: {displayText: '🎥 𝗩𝗜𝗗𝗘𝗢'}, type: 1},
{buttonId: `ytad ${res.mp3}`, buttonText: {displayText: '🎵 𝗠𝗨𝗦𝗜𝗖'}, type: 1}
]
let buttonMessage = {
image: {url:res.thumb},
caption: textyt,
...
💬 Title : ${data.title}\n📹 Quality : ${data.medias[0].quality}\n🎞️ Size : ${data.medias[0].formattedSize}\n⌛ Duration : ${data.duration}\n🔢 ID : ${data.medias[0].cached}\n🖇️ Link : ${data.url}\n\n*${botname}*`
  ...
  XeonBotInc.sendMessage(m.chat, { video: { url: data.medias[0].url }, jpegThumbnail:buf, caption: `💬 Title :  ${data.title}\n📹 Quality : ${data.medias[0].quality}\n🎞️ Size : ${data.medias[0].formattedSize}` }, { quoted: m })  
   ...
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!args.join(" ")) return reply("*Include Keywords After Command*")
try {
hx.pinterest(args.join(" ")).then(async(res) => {
imgnyee = res[Math.floor(Math.random() * res.length)]
let buttons = [
{buttonId: `pinterest ${args.join(" ")}`, buttonText: {displayText: '𝗡 𝗘 𝗫 𝗧'}, type: 1}
]
let buttonMessage = {
image: { url: imgnyee },
...
🎞️ Mime : ${baby1[0].mime}
🖇️ Link : ${baby1[0].link}\n
_Wait A Moment, The File Is Being Sent_`
reply(`${result4}`)
...
break
	...
	if (isBanChat) return reply(mess.banChat)
		...
		if (anu.type == 'video') {
			...
			caption: `*UMMA DOWNLOADER*\n
💬 Title : ${anu.title}
👤 Author : ${anu.author.name}
👍 Like : ${anu.like}
📝 Caption : ${anu.caption}
🖇️ Url : ${anu.media[0]}\n
_Select And Press The Button Below As Desired_
`,
			footer: XeonBotInc.user.name,
			buttons,
			headerType: 4
        ...
        case 'ringtone': {
        	if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
		if (!text) return reply(`*Example : ${prefix + command} charlie puth*`)
...
case 'tempo': {
if (isBan) return reply(mess.ban)
if (!args.join(" ")) return reply(`Reply Audio With Caption ${prefix + command} 10\n\n*Available 1 To 10 Volumes*`)
var req = args.join(' ')
...
View List Of Messages With ${prefix}listmsg`)
	...
	if (isBanChat) return reply(mess.banChat)
				...
				let buttons = [
                    { buttonId: 'Start', buttonText: { displayText: '𝗦 𝗧 𝗔 𝗥 𝗧' }, type: 1 }
                ]
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    let buttons = [
                        { buttonId: 'keluar', buttonText: { displayText: '𝗦 𝗧 𝗢 𝗣' }, type: 1 }
                    ]
                ...
                if (room) {
                    let buttons = [
                        { buttonId: 'next', buttonText: { displayText: '𝗦 𝗞 𝗜 𝗣' }, type: 1 },
                        { buttonId: 'keluar', buttonText: { displayText: '𝗦 𝗧 𝗢 𝗣' }, type: 1 }
                    ]
...
if (isBanChat) return reply(mess.banChat)
if (!isCreator) return
if (args.length < 1) return replay(`Type ACTIVE To Enable\nType NON-ACTIVE To Disable`)
if (args[0] === 'on') {
...
XeonBotInc.sendMessage(from, { react: { text: `${global.reactmoji}`, key: m.key }})
	                let btn = [{
                                ...
                                quickReplyButton: {
                                    displayText: '𝗔 𝗟 𝗟   𝗠 𝗘 𝗡 𝗨',
                                    id: 'allmenu'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: '𝗟 𝗜 𝗦 𝗧   𝗠 𝗘 𝗡 𝗨',
                                    id: 'command'
                                }  
                            }, {
                                quickReplyButton: {
                                    displayText: '𝗢 𝗪 𝗡 𝗘 𝗥',
                                    id: 'owner'
                                }
                            }]
                         let setbot = db.data.settings[botNumber]
            ...
            { quickReplyButton: { displayText: `𝗔 𝗟 𝗟   𝗠 𝗘 𝗡 𝗨`, id: 'allmenu'} },
            { quickReplyButton: { displayText: `𝗟 𝗜 𝗦 𝗧   𝗠 𝗘 𝗡 𝗨`, id: 'command'} },
            { quickReplyButton: { displayText: `𝗢 𝗪 𝗡 𝗘 𝗥`, id: 'owner'} }
        	]
...
await XeonBotInc.send5ButImg(from, `𝗨𝗦𝗘𝗥 𝗜𝗡𝗙𝗢 
• ɴᴀᴍᴇ ${pushname}
• ʟɪᴍɪᴛ ${getLimit(m.sender)}
• ʙʟᴏᴏᴅ ${getDarah(m.sender)}
...
case 'tqtt': 
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
reply(`*It is not mentioned by name who helped me, but I thank you very sincerely for helping the development of this bot.*`)
break
            default:
                if (budy.startsWith('=>')) {
                    if (!isCreator) return reply(mess.owner)
